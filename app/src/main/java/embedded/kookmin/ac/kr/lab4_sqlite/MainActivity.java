package embedded.kookmin.ac.kr.lab4_sqlite;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEtIndex = (EditText) findViewById(R.id.index_text);
        ...
        mBtRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                nameList.clear();
                selectAll();
                baseAdapter.notifyDataSetChanged(); // 변경된 데이터를 Listview에 적용하기위한 method호출
            }
        });
    ...
    public void createTable() {
        try {
            ...
            String sql = "create table " + tableName
                    + "(id integer primary key autoincrement, " + "name text not null)"; // primary key = 유니크한 필드
            db.execSQL(sql);
